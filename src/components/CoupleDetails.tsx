      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 relative z-10">
        ...
        >
          ...
          <div className="mb-4 flex flex-col items-center lg:items-end relative z-10">
            <span className="text-[#3B2C05] uppercase tracking-[0.4em] text-[10px] font-bold mb-3 block">The Groom</span>
            ...
            <p className="text-stone-800 font-serif italic text-base sm:text-lg font-medium">Son of Mr & Mrs Wijayarathne</p>
          </div>
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-start">
            <span className="text-[#3B2C05] uppercase tracking-[0.4em] text-[10px] font-bold mb-3 block mt-28 sm:mt-36 lg:mt-0">The Bride</span>
            <h3 className="text-4xl sm:text-5xl font-['Cormorant_Garamond',_serif] text-stone-800 mb-2 drop-shadow-sm">Avishka</h3>
            <p className="text-stone-700 font-century text-xs mb-2"></p>
            <p className="text-stone-800 font-serif italic text-base sm:text-lg font-medium">Daughter of Mr & Mrs Weerabahu</p>
          </div>
